...
## Usage
1. Download the latest release from the [releases page]() or compil the source code.
...
3. translate keys from untranslated.txt manually or with the help of a language model (they can preserve formatting). You can use Gemeni/Grock/ChatGpt and the following request: Translate localization file to <language name> preserving formatting ```<data from untranslated.txt>```
